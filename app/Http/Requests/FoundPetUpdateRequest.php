...
class FoundPetUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'primary_image' => ['nullable', 'image', 'mimes:png,jpeg,jpg', 'max:2048'],
            'secondary_image' => ['nullable', 'image', 'mimes:png,jpeg,jpg', 'max:2048'],
            'thirdary_image' => ['nullable', 'image', 'mimes:png,jpeg,jpg', 'max:2048'],
